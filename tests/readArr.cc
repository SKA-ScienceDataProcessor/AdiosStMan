...
int main(int argc, char **argv){
    ...
    Array<Bool> arr_Bool = col_Bool.get(1);
    ...
    Array<uChar> arr_uChar = col_uChar.get(1);
    ...
    Array<Short> arr_Short = col_Short.get(1);
    ...
    Array<uShort> arr_uShort = col_uShort.get(1);
    ...
    Array<Int> arr_Int = col_Int.get(1);
    ...
    Array<uInt> arr_uInt = col_uInt.get(1);
    ...
    Array<Float> arr_Float = col_Float.get(1);
    ...
    Array<Double> arr_Double = col_Double.get(1);
    ...
    Array<Complex> arr_Complex = col_Complex.get(1);
    ...
    Array<DComplex> arr_DComplex = col_DComplex.get(1);
